...
/*
* @brief Gets the CRC16 of a packet using the modbus algorithm
* @param `data`: The data of the packet
* @return The CRC16 of the packet
*/
...
#ifdef MANAGER
/*
* @brief Casts a buffer to a PACKET_T struct
* @param buffer: The buffer to cast
* @return The casted PACKET_T struct
*/
